    ...
    public class BrandSubcategorySeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<BrandSubcategory>().HasData(
                ...
                // Strymon
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000024") },
                // Elixir
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000038") },
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000039") },
                // Boss
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000007") },
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000009") },
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000025") },
                new BrandSubcategory { BrandId = Guid.Parse("00000000-0000-0000-0001-000000000012"), SubcategoryId = Guid.Parse("00000000-0000-0000-0003-000000000026") }
                );
        }
    }
