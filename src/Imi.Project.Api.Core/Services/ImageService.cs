...
namespace Imi.Project.Api.Core.Services
{
    ...
    { 
        ...
        { 
            ...
            var rootPath = Path.Combine(_webHostEnvironment.ContentRootPath, "wwwroot", "images", typeof(T).Name.ToLower()); 
            ...
            return new Uri($"{_httpContextAccessor.HttpContext.Request.Scheme}://{_httpContextAccessor.HttpContext.Request.Host.Value}/images/{typeof(T).Name.ToLower()}/{newFileNameWithExtension}", UriKind.Absolute); 
        } 
    }
}
